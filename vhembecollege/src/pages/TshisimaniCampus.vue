<template>
  <div class="q-pa-md row items-start q-gutter-md">
    <q-card class="my-card" flat bordered>
      ...
      <q-card-section>
      <div class="text-h5 q-mt-sm q-mb-xs">Tshisimani Campus</div>
...
<br> <br>
<strong>NCV programmes: L2 – L4 (Business and Engineering Studies) – 3 Years (36 Months)</strong><br>
Management<br>
Marketing<br>
...
Electrical Infrastructure Construction<br>
Engineering and Related Design<br><br>
